...
# Debloating GNOME
sudo zypper remove firefox yast2* vim* ruby* libreoffice* gnome-console gnome-calculator gnome-chess gnome-contacts gnome-sudoku gnome-system-monitor gnome-terminal gnome-weather gnome-remote-desktop gnome-music gnome-mines gnome-maps gnome-logs gnome-contacts gimp 

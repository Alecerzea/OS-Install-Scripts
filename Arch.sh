...
sudo pacman -Syyu
sudo pacman -S wireguard-tools cachyos-kernel-manager linux-cachyos-headers cachyos-settings fastfetch git wget qemu-full libvirt virt-manager python flatpak gparted sbctl adb

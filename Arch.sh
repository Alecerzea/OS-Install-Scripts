...
# Debloating GNOME
sudo pacman -R gnome-calculator gnome-calendar gnome-characters gnome-clocks gnome-connections gnome-console gnome-contacts gnome-control-center gnome-disk-utility gnome-logs gnome-maps gnome-music gnome-remote-desktop gnome-text-editor gnome-weather vim htop gnome-camera gnome-videos gnome-fonts

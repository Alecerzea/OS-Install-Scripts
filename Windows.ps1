...
winget install 7zip.7zip Adobe.Acrobat.Reader.64-bit Easeware.DriverEasy ElectronicArts.EADesktop EpicGames.EpicGamesLauncher Fastfetch-cli.Fastfetch Gyan.FFmpeg GitHub.GitHubDesktop HeroicGamesLauncher.HeroicGamesLauncher Jellyfin.JellyfinMediaPlayer Microsoft.PowerShell Mozilla.Firefox MullvadVPN.MullvadVPN Nvidia.GeForceNow Notepad++.Notepad++ Nlitesoft.NTLite OBSProject.OBSStudio Oracle.VirtualBox PlayStation.PSRemotePlay PPSSPPTeam.PPSSPP Proton.ProtonVPN Ubisoft.Connect Valve.Steam VideoLAN.VLC RevoUninstaller.RevoUninstaller qBittorrent.qBittorrent

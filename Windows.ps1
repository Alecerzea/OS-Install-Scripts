...
start explorer.exe
winget install 7zip.7zip Adobe.Acrobat.Reader.64-bit AzaharEmu.Azahar Brave.Brave Docker.Docker Easeware.DriverEasy ElectronicArts.EADesktop EpicGames.EpicGamesLauncher Fastfetch-cli.Fastfetch GOG.Galaxy Git.Git GitHub.GitHubDesktop Gyan.FFmpeg Microsoft.PowerShell Microsoft.VisualStudioCode Microsoft.WindowsTerminal Microsoft.WSL Mozilla.Firefox MullvadVPN.MullvadVPN Netbird.Netbird Notepad++.Notepad++ Nvidia.GeForceNow OBSProject.OBSStudio PlayStation.PSRemotePlay PPSSPPTeam.PPSSPP Proton.ProtonVPN PuTTY.PuTTY qBittorrent.qBittorrent RARLab.WinRAR RevoUninstaller.RevoUninstaller Tailscale.Tailscale Ubisoft.Connect VSCodium.VSCodium Valve.Steam VideoLAN.VLC WireGuard.WireGuard yt-dlp.yt-dlp --accept-source-agreements --accept-package-agreements --force && winget upgrade --all --include-unknown

...
winget install 7zip.7zip Adobe.Acrobat.Reader.64-bit AzaharEmu.Azahar Easeware.DriverEasy ElectronicArts.EADesktop EpicGames.EpicGamesLauncher Fastfetch-cli.Fastfetch GOG.Galaxy Gyan.FFmpeg Microsoft.PowerShell Mozilla.Firefox Notepad++.Notepad++ Nvidia.GeForceNow OBSProject.OBSStudio PlayStation.PSRemotePlay PPSSPPTeam.PPSSPP Proton.ProtonVPN RevoUninstaller.RevoUninstaller Ubisoft.Connect Valve.Steam VideoLAN.VLC
